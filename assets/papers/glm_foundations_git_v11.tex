...
\title{\textbf{Foundations of Generalised Linear Models, v11}\\
...
signed measure $\nu$ well-posed.
See the References section for classical treatments of
Hahn--Jordan decomposition and the R--N theorem for signed measures.
\end{remark}
...
\begin{itemize}[itemsep=6pt]
  \item P.~Halmos, \textit{Measure Theory}, Van Nostrand, 1950.
    Chapter~VI: Hahn and Jordan decompositions of signed measures.

  \item W.~Rudin, \textit{Real and Complex Analysis}, 3rd ed.,
    McGraw-Hill, 1987.
    Theorem~6.12: Radon--Nikodym theorem for complex (hence signed)
    measures; finiteness conditions discussed explicitly.

  \item V.~Bogachev, \textit{Measure Theory}, Vol.~1,
    Springer, 2007.
    \S3.10: modern treatment of the $\sigma$-finite case
    and subtleties of signed measures.

  \item N.~Dunford \& J.T.~Schwartz,
    \textit{Linear Operators}, Vol.~1,
    Interscience, 1958.
    III.7: signed measures as elements of the dual of $C_0$;
    functional-analytic perspective.

  \item R.~Galton, ``Regression towards mediocrity in hereditary
    stature,'' \textit{Journal of the Anthropological Institute},
    15:246--263, 1886.
    (Origin of the term ``regression.'')

  \item A.N.~Kolmogorov, \textit{Grundbegriffe der
    Wahrscheinlichkeitsrechnung}, Springer, 1933.
    Formalisation of conditional expectation as a
    Radon--Nikodym density.

  \item P.~McCullagh \& J.A.~Nelder,
    \textit{Generalized Linear Models}, 2nd ed.,
    Chapman \& Hall, 1989.
    Standard reference for GLM theory, exponential families,
    canonical links, and IRLS.

  \item H.~White, ``Maximum likelihood estimation of misspecified
    models,'' \textit{Econometrica}, 50(1):1--25, 1982.
    Consistency of MLE under misspecification; sandwich
    standard errors.

  \item R.W.M.~Wedderburn, ``Quasi-likelihood functions,
    generalized linear models, and the Gauss--Newton method,''
    \textit{Biometrika}, 61(3):439--447, 1974.
    Quasi-likelihood and the role of the variance function.
\end{itemize}
